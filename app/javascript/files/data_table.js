    ...
    loadDataTable() {
        this._table = $(CONTENTID).on('xhr.dt', function (e, settings, json, xhr) {
            ...
            columns: [
                ...
                { data: 'type', render: (data, type, row, meta) => data == 'd' ? '<span title="directory" class="fa fa-folder" style="color: gold"><span class="visually-hidden"> dir</span></span>' : '<span title="file" class="fa fa-file" style="color: lightgrey"><span class="visually-hidden"> file</span></span>' }, // type
