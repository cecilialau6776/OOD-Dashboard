...
jQuery(() => {
  ...
  $(".new_script").find(".editable-form-field").find(".btn-danger").on("click", (event) => {
    removeField(event);
  });
  $(".new_script").find(".editable-form-field").find(".btn-primary").on("click", (event) => {
    showEditField(event);
  });
...
//# sourceMappingURL=script_edit.js.map
