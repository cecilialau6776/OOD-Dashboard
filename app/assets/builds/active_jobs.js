...
var require_processing = __commonJS({
  "node_modules/datatables.net-plugins/api/processing().js"(exports, module) {
    (function(factory) {
      if (typeof define === "function" && define.amd) {
...
var import_processing = __toESM(require_processing());
...
(0, import_processing.default)(window, jQuery);
var entityMap = {
  "&": "&amp;",
  "<": "&lt;",
  ">": "&gt;",
